...
def check_access():
    ...
    # Mostrar formulario unificado de inicio de sesión
    st.markdown('''
        <div class="header-banner">
            <h1>🔒 Acceso Privado</h1>
            <p style="font-size: 1rem; margin: 0; color: #2B1B17; opacity: 0.85;">
                Introduce las credenciales requeridas para desbloquear la herramienta.
            </p>
        </div>
    ''', unsafe_allow_html=True)
    ...
    if st.button("🔑 Entrar"):
        # Modifica "miPassword123" por la clave de acceso rápido que quieras darle a tus amigos
